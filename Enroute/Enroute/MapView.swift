...
//  Enroute
//
//  Created by Terry Dengis on 9/7/20.
...
struct MapView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, MKMapViewDelegate {
        ...
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            let view = mapView.dequeueReusableAnnotationView(withIdentifier: "MapViewAnnotaion") ?? MKPinAnnotationView(annotation: annotation, reuseIdentifier: "MapViewAnnotaion")
